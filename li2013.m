...
str = {'Values',['\beta = ' num2str(b2)],...
    ['Z_t = ' num2str(Zt-Zc,'%#.4f') ' km ^+_- ' num2str(Zt_error,'%.4f') ' km'],...
    ['Z_0 = ' num2str(Z0-Zc,'%#.4f') ' km ^+_- ' num2str(p1_err,'%.4f') ' km'],...
    ['Z_b = ' num2str(Zb-Zc,'%#.4f') ' km ^+_- ' num2str(Zb_err,'%.4f') ' km'],...
